...
# nltk.download('punkt')
def app(search_input,search_abstract,search_title,search_author,search_date):
    l=[]
    ...
    # st.sidebar.title("SIMILARITY BASED")


    # Side panel
    # button1 = st.sidebar.button("TF-TIDF")
    # st.sidebar.title("FILTERING OPTIONS")

    # cont_based = st.sidebar.button("Content Based")
    # collab_based= st.sidebar.button("Collaborative Based")


    # button2 = st.sidebar.subheader("Collaborative Based")
    # button4 = st.sidebar.button("\tUser-Based Collaborative")
    # button4 = st.sidebar.button("Evaluation Metrics")
